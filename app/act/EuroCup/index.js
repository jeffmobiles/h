...
(function($){
	...
	$(".btn_submit").on("click",function(event){
        ...
        guList['deadline']='2016-6-15 00:00:00'; //截止时间
        ...
        //异步请求
        var urlInfo=gu_urlObj["production"]+'/mlottery/core/activity.subGuessData.do';
        $.ajax({
        	type:'POST',
        	url:urlInfo, 
    ...
    function validateInfo(data){
        ...
        if($.trim(data.phone)== ""||$.trim(data.userName)== ""){ 
	...
	var shareParam={
		...
		desc :'欧陆风云，谁能文鼎，一比分与你共同见证！',
        title :'we are together!欧洲杯有奖竞猜',
        imgUrl : gu_urlObj["production"]+'/active/dist/act/guess/img/wx_icon.jpg'
	}
